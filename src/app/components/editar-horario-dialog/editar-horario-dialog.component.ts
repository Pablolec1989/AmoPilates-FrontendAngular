...
@Component({
  selector: 'app-editar-horario-dialog',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  styleUrl: './editar-horario-dialog.component.scss'
})
export class EditarHorarioDialogComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<EditarHorarioDialogComponent>,
  ...
  async onSubmit(): Promise<void> {
    if (this.horarioForm.valid) {
      try {
        ...
        await firstValueFrom(this.apiService.updateHorario(this.data.horario.id, horarioData));
